            ...
            <a href="{{action('PagesController@storeCfsFlags')}}">All Cfs Flags</a>
                ...
                <div id="pageMiddle"><h3><span style="color: #636b6f;">
                            ...
                            <div class="text-center">
                                <img src="{{ asset("images/nn4mAbout1.png")}}"  alt="Image" /><img src="{{ asset("images/nn4mAbout2.png")}}" alt="Image" />
                                </br>
                                </br>
                                <img src="{{ asset("images/nn4mAbout3.png")}}" alt="Image" /><img src="{{ asset("images/nn4mAbout4.png")}}" alt="Image" />
                                </br>
                                </br>
                                <img src="{{ asset("images/nn4mAbout5.png")}}" alt="Image" /><img src="{{ asset("images/nn4mAbout6.png")}}" alt="Image" />
                            </div>
                        </br>
                    ...
                    <?php
                          ...
                          if($Stores != "")
                          {
                            ...
                            if($returnValue == '2')
                            {
                                $storeNames = DB::table('stores')->pluck('storeName');
                            ...
                            if($returnValue == '3')
                            {
                                $storeAddresses = DB::table('addresses')->pluck('addressLine_1', 'addressLine_2','addressLine_3');

                                foreach ($storeAddresses as $storeAddresse) {
                                    echo $storeAddresse;
                                    echo '</br>';
                                }
                            }
                              ...
                              if($returnValue == '4')
                              {
                                  $storeSites = DB::table('sites')->pluck('site');

                                  foreach ($storeSites as $storeSites) {
                                      echo $storeSites;
                                      echo '</br>';
                                  }
                              }
                              ...
                              if($returnValue == '5')
                              {
                                  $storeCfsFlags = DB::table('cfsFlags')->pluck('cfsFlag');

                                  foreach ($storeCfsFlags as $storeCfsFlag) {
                                      echo $storeCfsFlag;
                                      echo '</br>';
                                  }
                              }
