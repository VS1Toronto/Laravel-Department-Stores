...
<head>
        ...
        <title>Store Addresses Page</title>
                ...
                <div id="pageMiddle"><h3><span style="color: #636b6f;">
                        ...
                        @if(count($addresses) > 1)
                            @foreach($addresses as $addresse)
                                <div class="well">
                                    <small>Store Addresse {{$addresse->storeName}}</small>
                                    <h3>{{$addresse->address_line_1}}</h3>
                                    <h3>{{$addresse->address_line_2}}</h3>
                                    <h3>{{$addresse->address_line_3}}</h3>
                                </div>
                            @endforeach
                            @else
                                <p>No stores found</p>
